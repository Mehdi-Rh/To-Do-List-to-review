...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _variables_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./variables.js */ \"./src/variables.js\");\n/* harmony import */ var _classes_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./classes.js */ \"./src/classes.js\");\n\n\n\n\nconst taskList = new _classes_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\ntaskList.displayTask();\n\n// Add task\n_variables_js__WEBPACK_IMPORTED_MODULE_1__.addBtn.addEventListener('click', (event) => {\n  event.preventDefault();\n  if (_variables_js__WEBPACK_IMPORTED_MODULE_1__.input.value.length > 0) {\n    taskList.description = _variables_js__WEBPACK_IMPORTED_MODULE_1__.input.value;\n    taskList.addTask();\n  }\n  document.location.reload(true);\n  _classes_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].displayTask();\n  _variables_js__WEBPACK_IMPORTED_MODULE_1__.input.value = '';\n});\n\n// Clear completed\n_variables_js__WEBPACK_IMPORTED_MODULE_1__.clearCompleted.addEventListener('click', (event) => {\n  event.preventDefault();\n  for (let i = _variables_js__WEBPACK_IMPORTED_MODULE_1__.checkbox.length - 1; i >= 0; i -= 1) {\n    if (_variables_js__WEBPACK_IMPORTED_MODULE_1__.checkbox[i].checked === true) {\n      _variables_js__WEBPACK_IMPORTED_MODULE_1__.checkbox[i].parentElement.parentElement.remove();\n      taskList.removeTask(i);\n    }\n  }\n  taskList.setIndex();\n  document.location.reload(true);\n  _classes_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].displayTask();\n});\n\n// Update task\nif (_variables_js__WEBPACK_IMPORTED_MODULE_1__.taskBox.length > 0) {\n  for (let i = 0; i < _variables_js__WEBPACK_IMPORTED_MODULE_1__.taskBox.length; i += 1) {\n    _variables_js__WEBPACK_IMPORTED_MODULE_1__.taskBox[i].addEventListener('keypress', (event) => {\n      if (event.key === 'Enter') {\n        event.preventDefault();\n        taskList.updateTask(_variables_js__WEBPACK_IMPORTED_MODULE_1__.taskBox[i], i);\n        document.location.reload(true);\n        _classes_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].displayTask();\n      }\n    });\n  }\n}\n\n/* ********* Display delete icon ********* */\n// function to show and hide delete icon\nconst hideDisp = (itemToHide, itemToDisplay, index) => {\n  itemToHide[index].style.display = ('none');\n  itemToDisplay[index].style.display = ('block');\n};\n\n// Event to display delete icon\ndocument.addEventListener('click', (e) => {\n  const index = e.target.classList[1];\n\n  if (e.target.classList.contains('task-delete')) {\n    for (let i = 0; i < _variables_js__WEBPACK_IMPORTED_MODULE_1__.deleteIcon.length; i += 1) {\n      e.preventDefault();\n      hideDisp(_variables_js__WEBPACK_IMPORTED_MODULE_1__.deleteIcon, _variables_js__WEBPACK_IMPORTED_MODULE_1__.toHide, i);\n    }\n    const deleteIndex = e.target.classList[1];\n    hideDisp(_variables_js__WEBPACK_IMPORTED_MODULE_1__.toHide, _variables_js__WEBPACK_IMPORTED_MODULE_1__.deleteIcon, deleteIndex);\n  } else if (e.target.classList.contains('checkbox')) {\n    // Set completed or incompleted task\n    taskList.setCompleted(e.target.checked, index);\n  } else {\n    for (let i = 0; i < _variables_js__WEBPACK_IMPORTED_MODULE_1__.deleteIcon.length; i += 1) {\n      e.preventDefault();\n      hideDisp(_variables_js__WEBPACK_IMPORTED_MODULE_1__.deleteIcon, _variables_js__WEBPACK_IMPORTED_MODULE_1__.toHide, i);\n    }\n  }\n});\n\n// Event to delete a task when clicking on delete icon\n\nfor (let i = 0; i < _variables_js__WEBPACK_IMPORTED_MODULE_1__.deleteIcon.length; i += 1) {\n  const element = _variables_js__WEBPACK_IMPORTED_MODULE_1__.deleteIcon[i];\n  element.addEventListener('click', (e) => {\n    e.preventDefault();\n    element.parentElement.remove();\n    taskList.removeTask(i);\n    taskList.setIndex();\n    document.location.reload(true);\n  });\n}\n\n\n//# sourceURL=webpack://webpack-demo/./src/index.js?");
